...
//text replies with extra options
 ...
 msg.delete()}
else if (msgText === "valor") {message.channel.send(
  ...
  msg.delete()}
else if (msgText === "instinct") {message.channel.send(
